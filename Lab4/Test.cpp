...
void testConstructor1Invalid3() {
		// for constructor1
		int invalid_row3 = -4, invalid_col3 = -2;
		string row1="0 0 0 \n", row2="0 0 0 \n",row3="0 0 0 \n";
		string expected=row1+row2+row3;
		Matrix c = Matrix(invalid_row3,invalid_col3);
...
void testConstructor1Valid2() {
	...
	Matrix e = Matrix(valid_row,valid_col);
...
void testConstructor22() {
	  // for constructor2
	    int row=5,col=5;
        int data[5][5] = {{1,2,3,4,5},{6,7,8,9,0},{0,0,1,2,3},{0,0,0,4,5},{1,2,3,4,5}};
        int*input_data[5];
        for (int i=0;i<5;i++){
        	input_data[i]=data[i];
        }
...
void testGetElementValid2() {
	...
	Matrix f =  Matrix(row,col,input_data);
		...
		int expected= 2;
        ASSERT_EQUAL(expected,f.getElement(0, 1));
...
void testSetElementInvalid2() {
	  int value = 35;
	  int setinvalid_row = 9, setinvalid_col = 9;
	  int row=4,col=5;
      int data[4][5] = {{1,2,3,4,5},{6,7,8,9,0},{0,0,1,2,3},{0,0,0,4,5}};
	  int*input_data[4];
	    for (int i=0;i<4;i++){
...
void testCopy2() {
	...
	int row=5,col=5;
    int data[5][5] = {{1,2,3,4,5},{6,7,8,9,0},{0,0,1,2,3},{0,0,0,4,5},{1,2,3,4,6}};
	int*input_data[5];
	for (int i=0;i<5;i++){
	    	input_data[i]=data[i];
	}
...
void testAddToInvalid2() {
	   ...
	   /*Add-to Matrix*/
	    int row_to_add=5; int col_to_add=3;


		int add_to_data[5][3] = {{3,4,5}, {1,2,3}, {0,0,0},{1,2,1}, {1,2,3}}; // add to 'data' matrix, dimension not match

	 	int*add_input_data[5];
	 	for (int i=0;i<5;i++){
	 	    	add_input_data[i]=add_to_data[i];
	 	}
...
void testAddToValid2() {
	   int add_to_data[4][3] = {{3,4,5}, {1,2,3}, {1,1,1},{1,2,1}}; // add to 'data' matrix, dimension not match
	   int add_to_above[4][3] = {{1,1,-1}, {2,1,0}, {2,2,2},{0,-1,0}}; // add to 'add_to_data' matrix
	   int row=4;int col=3;
...
void testSubMatrixInvalid2() {
    ...
    int subinvalid_row = 4, subinvalid_col = 8;
...
void testIsUpperTrTrue2() {
	  ...
	  int row=4,col=3;
      int upper1[4][3] = {{2,5,7},{0,1,3},{0,0,5},{0,0,0}};
	  int*input_upper1[4];
	  for (int i=0;i<4;i++){
	    	input_upper1[i]=upper1[i];
	  }
...
/* -------------- Added --------------------- */
void testIsUpperTrFalseNotSquare2() {

	int row=4,col=3;
    int upper1[4][3] = {{1,4,1},{1,9,1},{0,2,4},{1,2,3}}; // not a square matrix
	int*input_upper1[4];
	for (int i=0;i<4;i++){
	    	input_upper1[i]=upper1[i];
	}
...
void testIsUpperTrFalse2() {
	...
	int row=3,col=4;
    int upper1[3][4] = {{7,6,1,4},{1,0,0,0},{7,3,6,3}};
	  int*input_upper1[3];
	  for (int i=0;i<3;i++){
	    	input_upper1[i]=upper1[i];
	  }
...
bool runAllTests(int argc, char const *argv[]) {
	...
	s.push_back(CUTE(testIsUpperTrFalseNotSquare2));
