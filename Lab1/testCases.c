...
*/
    ...
    void TestQ3_GapValue(CuTest *tc) {
...
//=================Question 4================================ 
    ...
    void TestQ4_3(CuTest *tc) {
    				...
    				int input = 3;
            double actual = Q4(input);
            double expected = 3.466667; //approx, accounted for in error
            CuAssertDblEquals(tc, expected, actual,0.0000009);
        }
//===========================================================
//=================Question 5================================ 
...
//=================Question 7================================  
    ...
    CuSuite* Lab1GetSuite() {
        ...
        SUITE_ADD_TEST(suite, TestQ2_6Digits);
        ...
        SUITE_ADD_TEST(suite, TestQ3_GapValue);
        ...
        SUITE_ADD_TEST(suite, TestQ6_28);
