...
void testSLLSetIntArray2() { 						// added <------------------

        int arr[] = {1, 5, 7, 9, 11, 12}; // this list

        SLLSet listObj2 = SLLSet(arr,6);
        string expectedSet = "1, 5, 7, 9, 11, 12";
        int expectedSize = 6;
        ASSERT_EQUAL(expectedSize,listObj2.getSize());
        ASSERT_EQUAL(expectedSet,listObj2.toString());
	}
...
void testCopy2() { 						// added <-------------------

        int arr[] = {1, 5, 7, 9, 11, 12}; // this list
        SLLSet listObj2 =  SLLSet(arr,6);
		SLLSet copied = listObj2.copy();
        copied.add(100);
        string expectedObj2 = "1, 5, 7, 9, 11, 12";
        string expectedCopied = "1, 5, 7, 9, 11, 12, 100";
...
void testAdd5() {					// added <-------------------
    ...
    SLLSet listObj2 =  SLLSet(arr,6);
        ...
        string expectedObj2 = "0, 1, 5, 7, 9, 11, 12";
...
void testRemove5() { 				// added <-------------------
    ...
    SLLSet listObj2 =  SLLSet(arr,6);
        ...
        string expectedObj2 = "5, 7, 9, 11, 12";
        int expectedObj2Size = 5;
...
void testUnionSLLSetArray2() { 						 // added <-------------------
        ...
        SLLSet listObj97 = SLLSet(arr4,2);
        SLLSet listObj96 = SLLSet();
        SLLSet listObjnew = SLLSet(arr0,4);

        SLLSet Array[] = {listObj100, listObj99, listObj98, listObj97, listObj96,listObjnew}; // test static SLLSet union(sArray)

		 SLLSet listObj23 = SLLSet::setUnion(Array,6);

		 string expected = "0, 1, 2, 3, 4, 6, 7, 11, 12";
		 int expectedSize = 9;
